...
const JOBS_API_URL = "http://127.0.0.1:8000/jobs";
...
const statusQuickButtonClasses: Record<JobStatus, string> = {
  ...
  Interview: "border-amber-200 bg-amber-100 text-amber-700 dark:border-amber-900 dark:bg-amber-900/50 dark:text-amber-300",
  Offer: "border-emerald-200 bg-emerald-100 text-emerald-700 dark:border-emerald-900 dark:bg-emerald-900/50 dark:text-emerald-300",
